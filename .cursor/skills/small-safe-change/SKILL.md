...
Read and follow **`repo operator and polyglot builder/I3/agent.md`** in full — that file is the source of truth for workflow, rules, and output format.
...
Write output to **`repo operator and polyglot builder/I3/change-report.md`** only (single `.md` file — no separate `.mmd`).
